...
const AgentsPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg p-8 mt-8 mb-8">
      ...
      <div className="bg-blue-100 border border-blue-200 text-blue-800 px-4 py-3 rounded-lg mb-6" role="alert">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="app-myZn5J4sZPO4lOXpFYLd9rij"
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="sk_car_gvwnAWPUG2hyRoRXYVroEH"
                      />
                    </div>
                    <div>
