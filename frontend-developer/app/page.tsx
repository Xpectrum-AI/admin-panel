            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {dropdownOpen && (
                    <div className={`absolute right-0 mt-3 w-80 rounded-2xl shadow-2xl z-10 animate-fade-in-down ${isDarkMode ? 'bg-gray-800/95 backdrop-blur-xl border border-gray-700/50' : 'bg-white border border-gray-200'}`}>
                      <div className={`p-6 ${isDarkMode ? 'border-b border-gray-700/50' : 'border-b border-gray-200'}`}>
