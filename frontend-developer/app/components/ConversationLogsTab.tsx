      ...
      return (
        <div className="w-full h-full max-w-full mx-auto p-2 sm:p-4 lg:p-6 min-h-0 overflow-hidden">
          <div className={`rounded-xl sm:rounded-2xl border shadow-xl backdrop-blur-sm h-full flex flex-col max-h-full ${isDarkMode ? 'bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 border-gray-700/50' : 'bg-gradient-to-br from-white via-gray-50 to-white border-gray-200/50'}`}>
            {/* Header */}
            <div className={`p-3 sm:p-4 lg:p-6 xl:p-8 border-b rounded-t-xl sm:rounded-t-2xl flex-shrink-0 ${isDarkMode ? 'border-gray-700/50 bg-gradient-to-r from-purple-900/20 to-blue-900/20' : 'border-gray-200/50 bg-gradient-to-r from-purple-50 to-blue-50'}`}>
              <div className="flex flex-col gap-3 sm:gap-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                  <div className="space-y-1 sm:space-y-2 min-w-0 flex-1">
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="p-1.5 sm:p-2 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg sm:rounded-xl flex-shrink-0">
              ...
              {message && (
                <div className={`mb-4 p-3 rounded-lg shadow-sm backdrop-blur-sm border ${messageType === 'success'
                  ...
                  : messageType === 'error'
                    ...
                    : isDarkMode ? 'bg-blue-900/20 border-blue-500/30 text-blue-300' : 'bg-blue-50 border-blue-200 text-blue-800'
                  }`}>
              ...
              {loadingAgents ? (
                <div className="flex flex-col items-center justify-center py-20">
                  <div className="relative">
                    <div className={`w-20 h-20 rounded-full border-4 ${isDarkMode ? 'border-purple-200 border-t-purple-600' : 'border-blue-200 border-t-blue-600'} animate-spin`}></div>
                    <div className="absolute inset-0 flex items-center justify-center">
                      <svg className={`w-8 h-8 ${isDarkMode ? 'text-purple-600' : 'text-blue-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {agents.map((agent) => (
                    <button
                      ...
                      className={`group relative rounded-xl p-4 shadow-md hover:shadow-lg border transition-all duration-300 text-left disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden ${isDarkMode
                        ? 'bg-gray-800/50 border-gray-700/50 hover:border-purple-500/50 hover:bg-gray-800/70'
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 via-blue-500 to-indigo-500 flex items-center justify-center text-white font-bold text-lg shadow-md group-hover:scale-105 transition-transform duration-300">
                            {agent.name ? agent.name.charAt(0).toUpperCase() : 'A'}
                          </div>
                          <div className="flex-1">
                            <h3 className={`font-bold text-lg group-hover:text-purple-600 transition-colors ${isDarkMode ? 'text-white' : 'text-gray-800'
                              }`}>
                      ...
                      {/* Arrow Icon */}
                      <div className={`absolute bottom-4 right-4 transition-colors ${isDarkMode ? 'text-gray-500 group-hover:text-purple-400' : 'text-gray-300 group-hover:text-purple-500'
                        }`}>
              ...
              <div className="flex flex-col gap-3 sm:gap-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    >
                      <svg className="w-4 h-4 group-hover:text-purple-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                      </svg>
                      <span className="font-semibold text-sm group-hover:text-purple-600 transition-colors">Back to Agents</span>
                    </button>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${activeTab === 'conversations'
                      ? isDarkMode ? 'bg-white text-purple-600' : 'bg-white text-purple-600'
              ...
              {loading ? (
                <div className="flex flex-col items-center justify-center py-20">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <svg className={`w-8 h-8 ${isDarkMode ? 'text-purple-600' : 'text-purple-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                      </svg>
                    </div>
                  </div>
                          ...
                          <div className="relative z-10 flex items-center justify-between">
                            <div className="flex-1 pr-3">
                              ...
                              <div className="flex items-start gap-2.5 mb-2.5">
                                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold shadow-sm group-hover:scale-105 transition-transform duration-300 flex-shrink-0">
                                  {idx + 1}
                                </div>
                                <div className="flex-1">
                                  <h3 className={`font-bold text-lg group-hover:text-purple-600 transition-colors mb-1 ${isDarkMode ? 'text-white' : 'text-gray-800'
                                    }`}>
                            ...
                            {/* Arrow */}
                            <div className={`flex items-center justify-center w-10 h-10 rounded-full group-hover:bg-purple-500 transition-colors duration-300 flex-shrink-0 ${isDarkMode
                              ? 'bg-gray-700/50 group-hover:bg-purple-500'
                              : 'bg-gray-100 group-hover:bg-purple-500'
                              }`}>
